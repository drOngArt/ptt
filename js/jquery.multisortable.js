...
!function($) {
  $.fn.multiselectable = function(options) {
    ...
    function click(e) {
      ...
      if(!mouseEvent && !item.hasClass(options.selectedClass)) {
          item.addClass(options.selectedClass);
        }
      if(mouseUnselect) {
          item.removeClass(options.selectedClass);
  ...
  $.fn.multisortable = function(options) {
    ...
    function unselect(list) {
      list.find('.' + settings.selectedClass).removeClass(options.selectedClass);
    }
